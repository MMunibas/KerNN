...
optional.add_argument("--interval",  type=float, help="interval for saving snapshots", default=500)
...
MaxwellBoltzmannDistribution(atoms, args.temperature * units.kB, force_temp=True)
ZeroRotation(atoms)
Stationary(atoms)
