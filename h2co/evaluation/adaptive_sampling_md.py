...
'''
script to run adaptive sampling using an ENSEMBLE OF KerNN models
...
calc = KerNNCalculator(
    model_path=["../training/models_ntrain3200_seed141/model_20240628_102258_900_seed141_ema", "../training/models_ntrain3200_seed141/model_20240628_102258_999_seed141_ema"], #load the model you want to used
    atoms=atoms,
    n_input=6,
    n_hidden=20,
    n_out=1)
