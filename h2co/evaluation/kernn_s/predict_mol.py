...
calc = KerNNCalculator(
    model_path="../final_models_h2co/sym2_3200_143/model_20240909_153352_1001642_seed143_ema", #load the model you want to used
    atoms=atoms,
    n_input=7,
    n_hidden=20,
    n_out=1)
...
#print results
print("Epot = " + str(epot) + " eV")#in eV
print("F = " + str(f) + " eV/ang") #in eV/angstrom
